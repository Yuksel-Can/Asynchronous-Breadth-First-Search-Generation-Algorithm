...
DataMessage::DataMessage(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    this->payload = 0;
}

DataMessage::DataMessage(const DataMessage& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
int DataMessage::getPayload() const
{
    return this->payload;
}

void DataMessage::setPayload(int payload)
{
...
DataMessageDescriptor::DataMessageDescriptor() : omnetpp::cClassDescriptor("DataMessage", "omnetpp::cMessage")
{
...
std::string DataMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    DataMessage *pp = (DataMessage *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getPayload());
        default: return "";
    }
}
...
bool DataMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    DataMessage *pp = (DataMessage *)object; (void)pp;
    switch (field) {
        case 0: pp->setPayload(string2long(value)); return true;
